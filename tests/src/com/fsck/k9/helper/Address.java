...
public class Address extends TestCase {
    ...
    public void testPraseWithValidEmail() {
        com.bernard.beaconportal.activities.mail.Address[] addresses =  com.bernard.beaconportal.activities.mail.Address.parse("Max Mustermann <maxmuster@mann.com>");
        assertEquals(1, addresses.length);
    ...
    public void testPraseWithValidEmailMulti() {
        com.bernard.beaconportal.activities.mail.Address[] addresses =  com.bernard.beaconportal.activities.mail.Address.parse("lorem@ipsum.us,mark@twain.com");
