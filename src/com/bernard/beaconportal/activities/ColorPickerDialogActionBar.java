...
public class ColorPickerDialogActionBar extends Dialog implements
	...
	public ColorPickerDialogActionBar(Context context, int initialColor) {
		super(context);
	...
	private void setUp(int color) {
		...
		if (color1 == 0) {
			...
			mOldColor.setColor(-12417548);
			mColorPicker.setColor(-12417548);
