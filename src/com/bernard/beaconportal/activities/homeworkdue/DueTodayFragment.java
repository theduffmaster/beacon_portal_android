...
public class DueTodayFragment extends Fragment {
	...
	private List<DueTodayList> due_today_list;
				...
				.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
					...
					private void check_download()
						...
						if (AppStatus.getInstance(getActivity()).isOnline(
							...
							due_today_list = new ArrayList<DueTodayList>();
	...
	public void onResume() {
		...
		lView.setDismissCallback(new de.timroes.android.listview.EnhancedListView.OnDismissCallback() {
			...
			public EnhancedListView.Undoable onDismiss(
				...
				final DueTodayList currenthomeworkdue = due_today_list
						.get(position);
	...
	public void parse_due_today_content() {
		...
		for (int i = 0; i < countersssss; i++) {
			...
			if (Type != null && Description != null && !Type.isEmpty()
				...
				if (!"Type".equals(Type)) {
					due_today_list.add(new DueTodayList(Band, Number, Class,
	...
	public class Due_TodayAdapter extends ArrayAdapter<DueTodayList> {
