...
public interface SearchSpecification extends Parcelable {
	...
	/**
	 * Returns the root node of the condition tree accompanying the search.
	 * 
	...
	// /////////////////////////////////////////////////////////////
	/*
	 * Using an enum in order to have more robust code. Users ( & coders ) are
	 * prevented from passing illegal fields. No database overhead when invalid
	 * fields passed.
	 * 
	 * By result, only the fields in here are searchable.
	 * 
	 * Fields not in here at this moment ( and by effect not searchable ): id,
	 * html_content, internal_date, message_id, preview, mime_type
	 */
	public enum Searchfield {
		SUBJECT, DATE, UID, FLAG, SENDER, TO, CC, FOLDER, BCC, REPLY_TO, MESSAGE_CONTENTS, ATTACHMENT_COUNT, DELETED, THREAD_ID, ID, INTEGRATE, READ, FLAGGED, DISPLAY_CLASS, SEARCHABLE
	}
	...
	// /////////////////////////////////////////////////////////////
	/**
	 * This class represents 1 value for a certain search field. One value
	 * consists of three things: an attribute: equals, starts with, contains,...
	 * a searchfield: date, flags, sender, subject,... a value: "apple",
	 * "jesse",..
	 * 
	 * @author dzan
	 */
	public class SearchCondition implements Parcelable {
		...
		public SearchCondition(Searchfield field, Attribute attribute,
				String value) {
			this.value = value;
		...
		public boolean equals(Object o) {
			if (o instanceof SearchCondition) {
				...
				if (tmp.attribute == attribute && tmp.field == field
