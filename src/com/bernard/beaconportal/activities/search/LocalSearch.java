 ...
 * 
 * Removing conditions could be done through matching there unique id in the
 * leafset and then removing them from the tree.
 * 
 * TODO implement a complete addAllowedFolder method TODO conflicting conditions
 * check on add TODO duplicate condition checking? TODO assign each node a
 * unique id that's used to retrieve it from the leaveset and remove.
 * 
 */
...
public class LocalSearch implements SearchSpecification {
	...
	// /////////////////////////////////////////////////////////////
	/**
	 * Use this only if the search won't be saved. Saved searches need a name!
	 */
	public LocalSearch() {
	}
	...
	/**
	 * Use this constructor when you know what you'r doing. Normally it's only
	 * used when restoring these search objects from the database.
	 * 
	 * @param name
	 *            Name of the search
	 * @param searchConditions
	 *            SearchConditions, may contains flags and folders
	 * @param accounts
	 *            Relative Account's uuid's
	 * @param predefined
	 *            Is this a predefined search or a user created one?
	 */
	...
	public LocalSearch clone() {
		ConditionsTreeNode conditions = (mConditions == null) ? null
				: mConditions.cloneTree();
	...
	// /////////////////////////////////////////////////////////////
	/**
	 * Sets the name of the saved search. If one existed it will be overwritten.
	 * 
	 * @param name
	 *            Name to be set.
	 */
	...
	/**
	 * Add a new account to the search. When no accounts are added manually we
	 * search all accounts on the device.
	 * 
	 * @param uuid
	...
	/**
	 * Adds all the account uuids in the provided array to be matched by the
	 * seach.
	 * 
	 * @param accountUuids
	 */
	...
	/**
	 * Adds the provided node as the second argument of an AND clause to this
	 * node.
	 * 
	 * @param field
	...
	/**
	 * Adds the provided condition as the second argument of an AND clause to
	 * this node.
	 * 
	 * @param condition
	...
	/**
	 * Adds the provided condition as the second argument of an OR clause to
	 * this node.
	 * 
	 * @param condition
	...
	/**
	 * Adds the provided node as the second argument of an OR clause to this
	 * node.
	 * 
	 * @param node
	 *            Node to 'OR' with.
	...
	/**
	 * TODO FOR NOW: And the folder with the root.
	 * 
	 * Add the folder as another folder to search in. The folder will be added
	 * AND to the root if no 'folder subtree' was found. Otherwise the folder
	 * will be added OR to that tree.
	 * 
	 * @param name
	...
	public void addAllowedFolder(String name) {
		/*
		 * TODO find folder sub-tree - do and on root of it & rest of search -
		 * do or between folder nodes
		 */
		mConditions = and(new SearchCondition(Searchfield.FOLDER,
				Attribute.EQUALS, name));
	}

	/*
	 * TODO make this more advanced! This is a temporarely solution that does
	 * NOT WORK for real searches because of possible extra conditions to a
	 * folder requirement.
	 */
	...
	/**
	 * Returns all the account uuids that this search will try to match against.
	 * 
