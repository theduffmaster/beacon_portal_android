 ...
 * <com.bernard.beaconportal.activities.view.FoldableLinearLayout
 * android:layout_width="wrap_content" android:layout_height="wrap_content"
 * custom:foldedLabel="@string/TEXT_TO_DISPLAY_WHEN_FOLDED"
 * custom:unFoldedLabel="@string/TEXT_TO_DISPLAY_WHEN_UNFOLDED"> <include
 * layout="@layout/ELEMENTS_TO_BE_FOLDED"/>
 * </com.bernard.beaconportal.activities.view.FoldableLinearLayout>
 */
public class FoldableLinearLayout extends LinearLayout {
	...
	private void processAttributes(Context context, AttributeSet attrs) {
		...
		boolean found = theme.resolveAttribute(R.attr.iconActionCollapse,
				outValue, true);
		if (found) {
		...
		if (attrs != null) {
			...
			mFoldedLabel = a
					.getString(R.styleable.FoldableLinearLayout_foldedLabel);
			mUnFoldedLabel = a
					.getString(R.styleable.FoldableLinearLayout_unFoldedLabel);
			a.recycle();
		}
	...
	static class SavedState extends BaseSavedState {
		...
		static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<FoldableLinearLayout.SavedState>() {
	...
	private void migrateChildrenToContainer() {
		...
		mFoldableLayout = inflator.inflate(R.layout.foldable_linearlayout,
				this, true);
		mFoldableContainer = (LinearLayout) mFoldableLayout
				.findViewById(R.id.foldableContainer);
	...
	private void initialiseInnerViews() {
		mFoldableIcon = (ImageView) mFoldableLayout
				.findViewById(R.id.foldableIcon);
		mFoldableTextView = (TextView) mFoldableLayout
				.findViewById(R.id.foldableText);
