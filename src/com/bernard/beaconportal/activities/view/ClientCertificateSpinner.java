...
public class ClientCertificateSpinner extends LinearLayout {
	...
	public void setOnClientCertificateChangedListener(
	...
	public ClientCertificateSpinner(Context context, AttributeSet attrs) {
		...
		if (context instanceof Activity) {
			...
			Log.e(K9.LOG_TAG,
					"ClientCertificateSpinner init failed! Please inflate with Activity!");
		}
	...
	public String getAlias() {
		...
		if (alias.equals(mActivity
				.getString(R.string.client_certificate_spinner_empty))) {
			return null;
		} else {
			return alias;
		}
	...
	public void chooseCertificate() {
		...
		KeyChain.choosePrivateKeyAlias(mActivity, new KeyChainAliasCallback() {
			...
			public void alias(String alias) {
				if (K9.DEBUG)
					Log.d(K9.LOG_TAG,
							"User has selected client certificate alias: "
									+ alias);
