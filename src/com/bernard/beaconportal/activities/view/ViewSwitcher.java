 ...
 * animations depending on which view is displayed.
 */
public class ViewSwitcher extends ViewAnimator implements AnimationListener {
	...
	public interface OnSwitchCompleteListener {
		/**
		 * This method will be called after the switch (including animation) has
		 * ended.
		 * 
		 * @param displayedChild
		 *            Contains the zero-based index of the child view that is
		 *            now displayed.
		 */
