...
import com.bernard.beaconportal.activities.helper.ClipboardManager;
...
public class SingleMessageView extends LinearLayout implements OnClickListener,
	...
	public void renderAttachments(Part part, int depth, Message message,
		...
		if (part.getBody() instanceof Multipart) {
			...
			for (int i = 0; i < mp.getCount(); i++) {
				renderAttachments(mp.getBodyPart(i), depth + 1, message,
