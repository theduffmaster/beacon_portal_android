...
/**
 * Defines the interface that {@link MessagingController} will use to callback
 * to requesters.
 * 
 * <p>
 * This class is defined as non-abstract so that someone who wants to receive
 * only a few messages can do so without implementing the entire interface. It
 * is highly recommended that users of this interface use the {@code @Override}
...
public class MessagingListener {
	...
	public void listLocalMessagesUpdateMessage(Account account, String folder,
			Message message) {
	}

	public void listLocalMessagesRemoveMessage(Account account, String folder,
			Message message) {
	}
	...
	public void synchronizeMailboxHeadersProgress(Account account,
			String folder, int completed, int total) {
	}

	public void synchronizeMailboxHeadersFinished(Account account,
			String folder, int totalMessagesInMailbox, int numNewMessages) {
	}

	public void synchronizeMailboxProgress(Account account, String folder,
	...
	public void synchronizeMailboxAddOrUpdateMessage(Account account,
	...
	public void loadMessageForViewHeadersAvailable(Account account,
	...
	/**
	 * Called when server has responded to our query. Messages have not yet been
	 * downloaded.
	 * 
	 * @param numResults
	 */
	...
	/**
	 * Called when a new result message is available for a remote search Can
	 * assume headers have been downloaded, but potentially not body.
	 * 
	 * @param account
	 * @param folder
	 * @param message
	 */
	public void remoteSearchAddMessage(Account account, String folder,
			Message message, int numDone, int numTotal) {
	}
	 ...
	 *            {@code true} if the controller will continue on to another
	 *            command immediately. {@code false} otherwise.
	 */
