...
import com.bernard.beaconportal.activities.AlphaPatternDrawable;
...
public class ColorPickerPreference extends Preference implements
		...
		ColorPickerDialogSecondary.OnColorChangedListener {

	View mView;
	ColorPickerDialogSecondary mDialog;
	...
	protected void showDialog(Bundle state) {
		mDialog = new ColorPickerDialogSecondary(getContext(), mValue);
