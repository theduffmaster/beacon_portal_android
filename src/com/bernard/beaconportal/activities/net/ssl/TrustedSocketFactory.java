...
public class TrustedSocketFactory {
	...
	static {
		...
		ENABLED_PROTOCOLS = (enabledProtocols == null) ? null : reorder(
				enabledProtocols, ORDERED_KNOWN_PROTOCOLS, null);
	}
	...
	public static Socket createSocket(SSLContext sslContext, Socket s,
