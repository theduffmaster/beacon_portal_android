...
public class ColorPickerDialog extends AlertDialog {
	...
	/**
	 * The interface users of {@link ColorPickerDialog} have to implement to
	 * learn the selected color.
	 */
	...
	public ColorPickerDialog(Context context, OnColorChangedListener listener,
		...
		View view = LayoutInflater.from(context).inflate(
				R.layout.color_picker_dialog, null);
				...
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						if (mColorChangedListener != null) {
							mColorChangedListener.colorChanged(mColorPicker
									.getColor());
						}
					}
				});
	 ...
	 * 
	 * @param color
	 *            The (A)RGB value of a color (the alpha channel will be
	 *            ignored).
	 */
