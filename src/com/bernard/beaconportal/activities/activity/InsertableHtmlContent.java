...
/**
 * <p>
 * Represents an HTML document with an insertion point for placing a reply. The
 * quoted document may have been modified to make it suitable for insertion. The
 * modified quoted document should be used in place of the original document.
 * </p>
 * 
 * <p>
 * Changes to the user-generated inserted content should be done with
 * {@link #setUserContent(String)}.
 * </p>
 * 
 * TODO: This container should also have a text part, along with its insertion
 * point. Or maybe a generic InsertableContent and maintain one each for Html
 * and Text?
 */
public class InsertableHtmlContent implements Serializable {
	...
	// Quoted message, if any. headerInsertionPoint refers to a position in this
	// string.
	...
	/**
	 * Defines where user content should be inserted, either before or after
	 * quoted content.
	 */
	...
	public void setHeaderInsertionPoint(int headerInsertionPoint) {
		if (headerInsertionPoint < 0
				|| headerInsertionPoint > quotedContent.length()) {
	...
	/**
	 * Set the quoted content. The insertion point should be set against this
	 * content.
	 * 
	 * @param content
	 */
	...
	/**
	 * <p>
	 * Insert something into the quoted content header. This is typically used
	 * for inserting reply/forward headers into the quoted content rather than
	 * inserting the user-generated reply content.
	 * </p>
	 * 
	 * <p>
	 * Subsequent calls to {@link #insertIntoQuotedHeader(String)} will
	 * <b>prepend</b> text onto any existing header and quoted content.
	 * </p>
	 * 
	 * @param content
	 *            Content to add.
	...
	/**
	 * <p>
	 * Insert something into the quoted content footer. This is typically used
	 * for inserting closing tags of reply/forward headers rather than inserting
	 * the user-generated reply content.
	 * </p>
	 * 
	 * <p>
	 * Subsequent calls to {@link #insertIntoQuotedFooter(String)} will
	 * <b>append</b> text onto any existing footer and quoted content.
	 * </p>
	 * 
	 * @param content
	 *            Content to add.
	...
	public void insertIntoQuotedFooter(final String content) {
		...
		// Update the location of the footer insertion point to the end of the
		// inserted content.
		footerInsertionPoint += content.length();
	}
	...
	/**
	 * Set the inserted content to the specified content. Replaces anything
	 * currently in the inserted content buffer.
	 * 
	 * @param content
	 */
	...
	/**
	 * Configure where user content should be inserted, either before or after
	 * the quoted content.
	 * 
	...
	public String toString() {
		...
		// Inserting and deleting was twice as fast as instantiating a new
		// StringBuilder and
		// using substring() to build the new pieces.
		String result = quotedContent.insert(insertionPoint,
				userContent.toString()).toString();
		quotedContent.delete(insertionPoint,
				insertionPoint + userContent.length());
		return result;
	}
	...
	public String toDebugString() {
		return "InsertableHtmlContent{" + "headerInsertionPoint="
				+ headerInsertionPoint + ", footerInsertionPoint="
				+ footerInsertionPoint + ", insertionLocation="
				+ insertionLocation + ", quotedContent=" + quotedContent
				+ ", userContent=" + userContent + ", compiledResult="
				+ toString() + '}';
	}
}
