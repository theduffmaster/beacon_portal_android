...
public class FolderInfoHolder implements Comparable<FolderInfoHolder> {
	 ...
	 * 
	 * <p>
	 * This will return localized strings for special folders like the Inbox or
	 * the Trash folder.
	 * </p>
	 * 
	 * @param context
	 ...
	 * 
	 * @return The localized name for the provided folder if it's a special
	 *         folder or the original folder name if it's a non-special folder.
	 */
