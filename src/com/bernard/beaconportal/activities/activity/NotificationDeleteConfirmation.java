...
public class NotificationDeleteConfirmation extends Activity {
	...
	public static PendingIntent getIntent(Context context,
		...
		return PendingIntent.getActivity(context, account.getAccountNumber(),
	...
	public void onPrepareDialog(int id, Dialog d) {
		...
		case DIALOG_CONFIRM:
			...
			alert.setMessage(getResources().getQuantityString(
					R.plurals.dialog_confirm_delete_messages, messageCount,
					messageCount));
			break;
		}
	...
	private void triggerDelete() {
		Intent i = NotificationActionService.getDeleteAllMessagesIntent(this,
				mAccount, mMessageRefs);
		startService(i);
	}
}
