...
public class K9ActivityCommon {
	/**
	 * Creates a new instance of {@link K9ActivityCommon} bound to the specified
	 * activity.
	 * 
	 * @param activity
	 *            The {@link Activity} the returned {@code K9ActivityCommon}
	 *            instance will be bound to.
	 * 
	 * @return The {@link K9ActivityCommon} instance that will provide the base
	 *         functionality of the "K9" activities.
	 */
	 ...
	 * of these methods in {@link K9ActivityCommon}.
	 * </p>
	 */
