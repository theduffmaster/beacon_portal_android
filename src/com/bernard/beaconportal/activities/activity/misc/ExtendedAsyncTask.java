...
/**
 * Extends {@link AsyncTask} with methods to attach and detach an
 * {@link Activity}.
 * 
 * <p>
 * This is necessary to properly handle configuration changes that will restart
 * an activity.
 * </p>
 * <p>
 * <strong>Note:</strong> Implementing classes need to make sure they have no
 * reference to the {@code Activity} instance that created the instance of that
 * class. So if it's implemented as inner class, it needs to be {@code static}.
 * </p>
 * 
 * @param <Params>
 *            see {@link AsyncTask}
 ...
 * @see #retain()
 */
public abstract class ExtendedAsyncTask<Params, Progress, Result> extends
		AsyncTask<Params, Progress, Result> implements NonConfigurationInstance {
	...
	/**
	 * Connect this {@link AsyncTask} to a new {@link Activity} instance after
	 * the activity was restarted due to a configuration change.
	 * 
	 * <p>
	 * This also creates a new progress dialog that is bound to the new
	 * activity.
	 * </p>
	 * 
	 * @param activity
	...
	/**
	 * Creates a {@link ProgressDialog} that is shown while the background
	 * thread is running.
	 * 
	 * <p>
	 * This needs to store a {@code ProgressDialog} instance in
	 * {@link #mProgressDialog} or override {@link #removeProgressDialog()}.
	 * </p>
	 */
