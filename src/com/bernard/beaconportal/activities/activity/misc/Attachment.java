 ...
 * 
 * This is used by
 * {@link com.bernard.beaconportal.activities.activity.MessageCompose} to fetch
...
public class Attachment implements Parcelable {
	...
	/**
	 * The name of the temporary file containing the local copy of the
	 * attachment.
	 * 
	...
	public static enum LoadingState {
		 ...
		 * 
		 * {@link #contentType}, {@link #name}, and {@link #size} should contain
		 * usable values.
		 */
		METADATA,

		/**
		 * The contents of the attachments have been copied to the temporary
		 * file {@link #filename}.
		 */
		COMPLETE,
