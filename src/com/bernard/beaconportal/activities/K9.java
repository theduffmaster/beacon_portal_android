...
public class K9 extends Application {
	 ...
	 * {@link #registerApplicationAware(com.bernard.beaconportal.activities.K9.ApplicationAware)}
	 * will immediately call
	 * {@link com.bernard.beaconportal.activities.K9.ApplicationAware#initializeComponent(K9)}
				...
				new MessagingListener() {
					private void broadcastIntent(String action,
						...
						try {
							...
							intent.putExtra(
									K9.Intents.EmailReceived.EXTRA_ACCOUNT,
									account.getDescription());
							intent.putExtra(
									K9.Intents.EmailReceived.EXTRA_FOLDER,
									folder);
							intent.putExtra(
									K9.Intents.EmailReceived.EXTRA_SENT_DATE,
									message.getSentDate());
							intent.putExtra(
									K9.Intents.EmailReceived.EXTRA_FROM,
							...
							intent.putExtra(
									K9.Intents.EmailReceived.EXTRA_SUBJECT,
									message.getSubject());
							intent.putExtra(
					...
					public void synchronizeMailboxRemovedMessage(
							Account account, String folder, Message message) {
						broadcastIntent(
								K9.Intents.EmailReceived.ACTION_EMAIL_DELETED,
					...
					public void synchronizeMailboxNewMessage(Account account,
						...
						broadcastIntent(
								K9.Intents.EmailReceived.ACTION_EMAIL_RECEIVED,
								account, folder, message);
						updateUnreadWidget();
					}
					...
					public void folderStatusChanged(Account account,
						...
						Intent intent = new Intent(
								K9.Intents.EmailReceived.ACTION_REFRESH_OBSERVER,
								null);
						intent.putExtra(K9.Intents.EmailReceived.EXTRA_ACCOUNT,
								account.getDescription());
						intent.putExtra(K9.Intents.EmailReceived.EXTRA_FOLDER,
								folderName);
						K9.this.sendBroadcast(intent);
	...
	public static void loadPrefs(Preferences prefs) {
		...
		K9.setUseFixedMessageViewTheme(sprefs.getBoolean(
	...
	/**
	 * Register a component to be notified when the {@link K9} instance is
	 * ready.
	 * 
	 * @param component
