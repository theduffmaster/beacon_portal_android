...
/**
 * Utillity definitions for Android applications to control the behavior of K-9
 ...
 * messages to K-9 Mail must
 * 
 * An application that wishes to act on a particular Account in K-9 needs to
 * fetch the list of configured Accounts by broadcasting an {@link Intent} using
 * K9_REQUEST_ACCOUNTS as the Action. The broadcast must be made using the
...
public class K9RemoteControl {
	/**
	 * Permission that every application sending a broadcast to K-9 for Remote
	 * Control purposes should send on every broadcast. Prevent other
	 * applications from intercepting the broadcasts.
	 */
	public final static String K9_REMOTE_CONTROL_PERMISSION = "com.bernard.beaconportal.activities.permission.REMOTE_CONTROL";
	/**
	 * {@link Intent} Action to be sent to K-9 using
	 ...
	 * K9_ACCOUNT_UUIDS and K9_ACCOUNT_DESCRIPTIONS
	 */
	public final static String K9_REQUEST_ACCOUNTS = "com.bernard.beaconportal.activities.K9RemoteControl.requestAccounts";
	public final static String K9_ACCOUNT_UUIDS = "com.bernard.beaconportal.activities.K9RemoteControl.accountUuids";
	public final static String K9_ACCOUNT_DESCRIPTIONS = "com.bernard.beaconportal.activities.K9RemoteControl.accountDescriptions";

	/**
	 * The {@link {@link Intent} Action to set in order to cause K-9 to check
	 * mail. (Not yet implemented)
	 */
	// public final static String K9_CHECK_MAIL =
	// "com.bernard.beaconportal.activities.K9RemoteControl.checkMail";

	/**
	 * The {@link {@link Intent} Action to set when remotely changing K-9 Mail
	 * settings
	 */
	public final static String K9_SET = "com.bernard.beaconportal.activities.K9RemoteControl.set";
	/**
	 * The key of the {@link Intent} Extra to set to hold the UUID of a single
	 * Account's settings to change. Used only if K9_ALL_ACCOUNTS is absent or
	 * false.
	 */
	public final static String K9_ACCOUNT_UUID = "com.bernard.beaconportal.activities.K9RemoteControl.accountUuid";
	/**
	 * The key of the {@link Intent} Extra to set to control if the settings
	 * will apply to all Accounts, or to the one specified with K9_ACCOUNT_UUID
	 */
	public final static String K9_ALL_ACCOUNTS = "com.bernard.beaconportal.activities.K9RemoteControl.allAccounts";
	 ...
	 * will be generated for new unread mail. Acceptable values are K9_ENABLED
	 * and K9_DISABLED
	 */
	public final static String K9_NOTIFICATION_ENABLED = "com.bernard.beaconportal.activities.K9RemoteControl.notificationEnabled";
	/*
	 * Key for the {@link Intent} Extra for controlling whether K-9 will sound
	 * the ringtone for new unread mail. Acceptable values are K9_ENABLED and
	 * K9_DISABLED
	 */
	public final static String K9_RING_ENABLED = "com.bernard.beaconportal.activities.K9RemoteControl.ringEnabled";
	/*
	 * Key for the {@link Intent} Extra for controlling whether K-9 will
	 * activate the vibrator for new unread mail. Acceptable values are
	 * K9_ENABLED and K9_DISABLED
	 */
	public final static String K9_VIBRATE_ENABLED = "com.bernard.beaconportal.activities.K9RemoteControl.vibrateEnabled";
	 ...
	 * be synchronized with Push. Acceptable values are K9_FOLDERS_ALL,
	 * K9_FOLDERS_FIRST_CLASS, K9_FOLDERS_FIRST_AND_SECOND_CLASS,
	 * K9_FOLDERS_NOT_SECOND_CLASS, K9_FOLDERS_NONE
	 */
	public final static String K9_PUSH_CLASSES = "com.bernard.beaconportal.activities.K9RemoteControl.pushClasses";
	/**
	 * Key for the {@link Intent} Extra to set for controlling which folders to
	 * be synchronized with Poll. Acceptable values are K9_FOLDERS_ALL,
	 * K9_FOLDERS_FIRST_CLASS, K9_FOLDERS_FIRST_AND_SECOND_CLASS,
	 * K9_FOLDERS_NOT_SECOND_CLASS, K9_FOLDERS_NONE
	 */
	public final static String K9_POLL_CLASSES = "com.bernard.beaconportal.activities.K9RemoteControl.pollClasses";

	public final static String[] K9_POLL_FREQUENCIES = { "-1", "1", "5", "10",
	 ...
	 * are available in K9_POLL_FREQUENCIES
	 */
	public final static String K9_POLL_FREQUENCY = "com.bernard.beaconportal.activities.K9RemoteControl.pollFrequency";
	 ...
	 * theme K-9 will use. Acceptable values are K9_THEME_LIGHT, K9_THEME_DARK
	 */
	public final static String K9_THEME = "com.bernard.beaconportal.activities.K9RemoteControl.theme";
	...
	public static void set(Context context, Intent broadcastIntent) {
		...
		context.sendBroadcast(broadcastIntent,
				K9RemoteControl.K9_REMOTE_CONTROL_PERMISSION);
	}
	...
	public static void fetchAccounts(Context context, K9AccountReceptor receptor) {
		...
		context.sendOrderedBroadcast(accountFetchIntent,
				K9RemoteControl.K9_REMOTE_CONTROL_PERMISSION, receiver, null,
