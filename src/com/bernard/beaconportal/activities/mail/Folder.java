...
public abstract class Folder {
	...
	// NONE is obsolete, it will be translated to NO_CLASS for display and to
	// INHERITED for sync and push
	...
	/**
	 * Get the mode the folder was opened with. This may be different than the
	 * mode the open was requested with.
	 * 
	 * @return
	 */
	 ...
	 * remote folders to not override or worry about this call if they don't
	 * care to.
	 */
	...
	/**
	 * Fetch the shells of messages between a range of UIDs and after a given
	 * date.
	 * 
	 * @param start
	 *            UID sequence start
	 ...
	 *            Date to start on
	 * @param listener
	 *            Listener to notify as we download messages.
	 * @return List of messages
	 * @throws MessagingException
	 */
	public abstract Message[] getMessages(int start, int end,
			Date earliestDate, MessageRetrievalListener listener)
			throws MessagingException;
	...
	public Message[] getMessages(MessageRetrievalListener listener,
			boolean includeDeleted) throws MessagingException {
		return getMessages(listener);
	}

	public abstract Message[] getMessages(String[] uids,
			MessageRetrievalListener listener) throws MessagingException;

	public abstract Map<String, String> appendMessages(Message[] messages)
			throws MessagingException;
	...
	public Map<String, String> moveMessages(Message[] msgs, Folder folder)
			throws MessagingException {
		return null;
	}
	...
	public abstract void setFlags(Message[] messages, Flag[] flags,
			boolean value) throws MessagingException;

	public abstract void setFlags(Flag[] flags, boolean value)
			throws MessagingException;
	...
	/**
	 * Populate a list of messages based upon a FetchProfile. See
	 * {@link FetchProfile} for the things that can be fetched.
	 * 
	 * @param messages
	...
	/**
	 * Indicated by the server "\*" ( * OK [PERMANENTFLAGS (\Answered .. \*)]
	 * Flags permitted). that new keywords may be created
	 */
	 ...
	 * @param oldPushState
	 * @param message
	 * @return empty string to clear the pushState, null to leave the state
	 *         as-is
	 */
