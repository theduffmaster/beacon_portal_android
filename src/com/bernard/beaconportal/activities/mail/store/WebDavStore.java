...
public class WebDavStore extends Store {
	...
	public WebDavHttpClient getHttpClient() throws MessagingException {
		if (mHttpClient == null) {
			...
			try {
				...
				Log.e(K9.LOG_TAG, "NoSuchAlgorithmException in getHttpClient: "
						+ nsa);
				throw new MessagingException(
						"NoSuchAlgorithmException in getHttpClient: " + nsa);
			} catch (KeyManagementException kme) {
				Log.e(K9.LOG_TAG, "KeyManagementException in getHttpClient: "
						+ kme);
				throw new MessagingException(
	...
	private DataSet processRequest(String url, String method,
		...
		if (K9.DEBUG && K9.DEBUG_PROTOCOL_WEBDAV) {
			Log.v(K9.LOG_TAG, "processRequest url = '" + url + "', method = '"
	...
	class WebDavFolder extends Folder {
		...
		private void moveOrCopyMessages(Message[] messages, String folderName,
			...
			Log.i(K9.LOG_TAG, "Moving " + messages.length + " messages to "
		...
		private int getMessageCount(boolean read) throws MessagingException {
			...
			if (K9.DEBUG && K9.DEBUG_PROTOCOL_WEBDAV) {
				Log.v(K9.LOG_TAG, "Counted messages and webdav returned: "
						+ messageCount);
			}
	...
	class WebDavMessage extends MimeMessage {
		...
		public void delete(String trashFolderName) throws MessagingException {
			...
			Log.i(K9.LOG_TAG, "Deleting message by moving to "
					+ trashFolderName);
