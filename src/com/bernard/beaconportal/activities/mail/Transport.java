...
import com.bernard.beaconportal.activities.mail.transport.WebDavTransport;
...
public abstract class Transport {
	...
	public synchronized static Transport getInstance(Account account)
		...
		if (uri.startsWith("smtp")) {
			...
			throw new MessagingException(
					"Unable to locate an applicable Transport for " + uri);
		}
	}

	/**
	 * Decodes the contents of transport-specific URIs and puts them into a
	...
	/**
	 * Creates a transport URI from the information supplied in the
	 * {@link ServerSettings} object.
	 * 
	 * @param server
	 ...
	 *            settings.
	 * 
	 * @return A transport URI that holds the same information as the
