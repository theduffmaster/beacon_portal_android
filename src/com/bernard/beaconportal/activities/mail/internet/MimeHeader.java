...
public class MimeHeader {
	...
	/**
	 * Application specific header that contains Store specific information
	 * about an attachment. In IMAP this contains the IMAP BODYSTRUCTURE part id
	 * so that the ImapStore can later retrieve the attachment at will from the
	 * server. The info is recorded from this header on
	 * LocalStore.appendMessages and is put back into the MIME data by
	 * LocalStore.fetch.
	 */
