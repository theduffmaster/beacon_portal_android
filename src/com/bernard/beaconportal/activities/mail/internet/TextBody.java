...
public class TextBody implements Body {
	...
	// Length of the message composed (as opposed to quoted). I don't like the
	// name of this variable and am open to
	...
	public void writeTo(OutputStream out) throws IOException,
		...
		if (mBody != null) {
			...
			if (MimeUtil.ENC_8BIT.equalsIgnoreCase(mEncoding)) {
				...
				QuotedPrintableOutputStream qp = new QuotedPrintableOutputStream(
						out, false);
				qp.write(bytes);
				qp.flush();
				qp.close();
