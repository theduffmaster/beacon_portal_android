 ...
 * 
 * This class is copied from the org.apache.james.mime4j.decoder.DecoderUtil
 * class. It's modified here in order to decode emoji characters in the Subject
...
public class DecoderUtil {
	...
	private static String decodeB(String encodedWord, String charset) {
		...
		Base64InputStream is = new Base64InputStream(new ByteArrayInputStream(
				bytes));
		try {
