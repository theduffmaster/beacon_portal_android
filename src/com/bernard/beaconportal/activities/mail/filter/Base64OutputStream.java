...
package com.bernard.beaconportal.activities.mail.filter;
...
public class Base64OutputStream extends FilterOutputStream {
	 ...
	 *            lineLength characters. If lineLength <=0, the encoded data is
	 *            not divided into lines. If doEncode is false, lineLength is
	 *            ignored.
	 * @param lineSeparator
	...
	/**
	 * Closes this output stream, flushing any remaining bytes that must be
	 * encoded. The underlying stream is flushed but not closed.
	 */
	@Override
