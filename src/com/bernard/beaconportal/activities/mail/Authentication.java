...
public class Authentication {
	...
	/**
	 * Computes the response for CRAM-MD5 authentication mechanism given the
	 * user credentials and the server-provided nonce.
	 * 
	 * @param username
	 *            The username.
	 * @param password
	 *            The password.
	 * @param b64Nonce
	 *            The nonce as base64-encoded string.
	 ...
	 */
	public static String computeCramMd5(String username, String password,
			String b64Nonce) throws MessagingException {

		try {
			byte[] b64NonceBytes = b64Nonce.getBytes(US_ASCII);
			byte[] b64CRAM = computeCramMd5Bytes(username, password,
					b64NonceBytes);
	 ...
	 *            The password.
	 * @param b64Nonce
	 *            The nonce as base64-encoded byte array.
	 ...
	 */
	public static byte[] computeCramMd5Bytes(String username, String password,
			byte[] b64Nonce) throws MessagingException {
		...
		try {
			...
			throw new MessagingException(
					"Something went wrong during CRAM-MD5 computation", e);
		}
	}
}
