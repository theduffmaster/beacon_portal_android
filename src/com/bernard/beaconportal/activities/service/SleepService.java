...
public class SleepService extends CoreService {
	...
	private static String ALARM_FIRED = "com.bernard.beaconportal.activities.service.SleepService.ALARM_FIRED";
	private static String LATCH_ID = "com.bernard.beaconportal.activities.service.SleepService.LATCH_ID_EXTRA";
	...
	public static void sleep(Context context, long sleepTime,
		...
		i.setClassName(context.getPackageName(),
				"com.bernard.beaconportal.activities.service.SleepService");
